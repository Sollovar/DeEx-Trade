      ...
      <div className="p-3 flex flex-col gap-3 overflow-y-auto">
        ...
        {!isConnected ? (
          <DynamicConnectButton buttonContainerClassName="w-full">
            <div
              className="w-full font-bold py-3 text-[14px] transition-colors mt-1 rounded-sm text-center cursor-pointer"
          ...
          <button
            ...
            className="w-full font-bold py-3 text-[14px] transition-colors mt-1 rounded-sm disabled:opacity-60"
            style={{
