    ...
    <div className="flex-1 min-h-0 overflow-y-auto" style={{ paddingBottom: 76 }}>
        ...
        <div className="px-5 pt-3 pb-5">
          ...
          {loading || syncing ? (
            ...
            <div className="flex flex-col gap-2">
              <p style={{ fontSize: 14, color: "var(--m-fg-5)" }}>Unable to fetch portfolio</p>
              <button
                onClick={refetch}
            ...
            <>
              ...
              <div className="flex items-center gap-3 mt-3 flex-wrap">
                ...
                >
                  <span style={{ fontSize: 11, color: "var(--m-fg-5)", fontWeight: 600 }}>All-time:</span>
              ...
              <p style={{ fontSize: 11, color: "var(--m-fg-5)", marginTop: 10 }}>
                Cost basis: <span style={{ fontVariantNumeric: "tabular-nums" }}>${fmt(summary.totalCostUsd)}</span>
                {" · "}Unrealized PnL:{" "}
      ...
      >
        {loading || syncing ? (
          ...
          <p className="px-4 py-4 text-[13px]" style={{ color: "var(--m-fg-5)" }}>Could not load holdings</p>
        ) : holdings.length === 0 ? (
          <p className="px-4 py-4 text-[13px]" style={{ color: "var(--m-fg-5)" }}>No holdings found on this network</p>
        ) : (
          holdings.map((h, i) => (
