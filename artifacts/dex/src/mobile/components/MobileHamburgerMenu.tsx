...
export function MobileHamburgerMenu({ open, onClose }: Props) {
  ...
  const NAV_MAIN = [
    { icon: TrendingUp,  labelKey: "nav.trade",     tag: null },
    { icon: BarChart2,   labelKey: "nav.markets",   tag: null },
    { icon: Wallet,      labelKey: "nav.portfolio", tag: null },
    { icon: Zap,         labelKey: "menu.earn",     tag: t('menu.new') },
    { icon: ShieldCheck, labelKey: "menu.insurance", tag: null },
  ];

  const NAV_RESOURCES = [
    { icon: BookOpen,   labelKey: "menu.docs",    href: true },
    { icon: FileText,   labelKey: "menu.blog",    href: true },
    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-3 shrink-0">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[13px] font-semibold text-[#f5c518]">{t('menu.connectWallet')}</span>
            </div>
        ...
        <div className="px-3 py-2 shrink-0">
          ...
          {NAV_MAIN.map(({ icon: Icon, labelKey, tag }) => (
            <button
              key={labelKey}
              onClick={onClose}
