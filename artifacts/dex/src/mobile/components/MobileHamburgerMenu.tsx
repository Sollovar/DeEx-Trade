...
const NAV_MAIN = [
  { icon: TrendingUp,  label: "Trade",      tag: null },
  { icon: BarChart2,   label: "Markets",    tag: null },
  { icon: Wallet,      label: "Portfolio",  tag: null },
  { icon: Zap,         label: "Earn",       tag: "New" },
  { icon: ShieldCheck, label: "Insurance",  tag: null },
];

const NAV_RESOURCES = [
  { icon: BookOpen,   label: "Docs",    href: true },
  { icon: FileText,   label: "Blog",    href: true },
  { icon: HelpCircle, label: "Support", href: true },
];
...
export function MobileHamburgerMenu({ open, onClose }: Props) {
  return (
    <>
      <div
        onClick={onClose}
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 h-[58px] shrink-0">
          <div className="flex items-center gap-2">
            <div
              className="w-6 h-6 bg-[#f5c518] flex items-center justify-center shrink-0"
        ...
        <div className="px-4 pb-3 shrink-0">
          <button
            className="w-full flex items-center justify-between px-4 h-[48px] rounded-xl transition-all active:scale-[0.98]"
            style={{
          ...
          >
            <div className="flex items-center gap-2.5">
              <Wallet className="w-4 h-4 text-[#f5c518]" />
              <span className="text-[13px] font-semibold text-[#f5c518]">Connect Wallet</span>
            </div>
            <ChevronRight className="w-4 h-4 text-[#f5c518]/60" />
          </button>
        </div>
        ...
        <div className="px-3 py-2 shrink-0">
          ...
          {NAV_MAIN.map(({ icon: Icon, label, tag }) => (
            <button
              key={label}
              onClick={onClose}
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {tag && (
                  <span className="text-[10px] font-bold bg-[#f5c518] text-black px-2 py-0.5 rounded-full">
                    {tag}
                  </span>
                )}
        ...
        <div className="px-3 py-2 shrink-0">
          ...
          {NAV_RESOURCES.map(({ icon: Icon, label }) => (
            <button
              key={label}
              onClick={onClose}
              className="w-full flex items-center justify-between px-3 h-[44px] rounded-xl transition-all active:opacity-70"
        ...
        <div className="px-3 py-2 shrink-0">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-[14px] font-medium" style={{ color: "var(--m-fg-2)" }}>Settings</span>
            </div>
            <ChevronRight style={{ width: 14, height: 14, color: "var(--m-fg-5)" }} />
          </button>
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px]" style={{ color: "var(--m-fg-4)" }}>All systems operational</span>
          </div>
        </div>
      </div>
    </>
