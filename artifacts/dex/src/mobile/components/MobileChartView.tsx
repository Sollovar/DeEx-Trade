      ...
      >
        ...
        >
          <button
            ...
            className="relative flex items-center px-3.5 h-[28px] rounded-[9px] text-[12px] font-semibold transition-all duration-200"
            style={{
              backgroundColor: chartMode === "market" ? "#f5c518" : "transparent",
              color: chartMode === "market" ? "#000" : "var(--m-fg-4)",
              boxShadow: chartMode === "market" ? "0 1px 4px rgba(245,197,24,0.25)" : "none",
            }}
          >
            Market
          </button>
          <button
            onClick={() => setChartMode("exchange")}
            className="flex items-center gap-1.5 px-3.5 h-[28px] rounded-[9px] text-[12px] font-semibold transition-all duration-200"
            style={{
              backgroundColor: chartMode === "exchange" ? "#f5c518" : "transparent",
              color: chartMode === "exchange" ? "#000" : "var(--m-fg-4)",
              boxShadow: chartMode === "exchange" ? "0 1px 4px rgba(245,197,24,0.25)" : "none",
            }}
          >
            Exchange
          </button>
        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
          ...
          <div className="relative flex-1 min-h-0 overflow-hidden" style={{ minHeight: 320 }}>
            ...
            <div className="absolute inset-0 pl-9">
              <CandlestickChart livePrice={livePrice} showToolbar={false} pairId={pairId} timeframe={tf} />
            </div>
            <ALButtons />
          </div>
