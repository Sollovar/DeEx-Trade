...
const translations: Record<string, Record<LanguageCode, string>> = {
  ...
  'landing.why.title': {
    en: 'Why NEXUS', zh: '为何选择 NEXUS', es: 'Por qué NEXUS', ru: 'Почему NEXUS', pt: 'Por que NEXUS', ar: 'لماذا NEXUS', tr: 'Neden NEXUS', ko: '왜 NEXUS인가',
  },
  ...
  'landing.platform.title': { en: 'The NEXUS Experience', zh: 'NEXUS 体验', es: 'La Experiencia NEXUS', ru: 'Опыт NEXUS', pt: 'A Experiência NEXUS', ar: 'تجربة NEXUS', tr: 'NEXUS Deneyimi', ko: 'NEXUS 경험' },
  ...
  'landing.row1.desc': {
    en: 'Equities, commodities, prediction markets, AI tokens. NEXUS gives you access to every on-chain market — anytime, anywhere.',
    zh: '股票、大宗商品、预测市场、AI 代币。NEXUS 为您提供访问每个链上市场的机会——随时随地。',
    es: 'Acciones, materias primas, mercados de predicción, tokens de IA. NEXUS te da acceso a todos los mercados on-chain.',
    ru: 'Акции, сырьё, рынки предсказаний, AI-токены. NEXUS даёт доступ к каждому рынку на блокчейне.',
    pt: 'Ações, commodities, mercados de previsão, tokens de IA. NEXUS te dá acesso a todos os mercados on-chain.',
    ar: 'الأسهم والسلع وأسواق التنبؤ ورموز الذكاء الاصطناعي. NEXUS يمنحك الوصول إلى كل سوق على السلسلة.',
    tr: 'Hisse senetleri, emtialar, tahmin piyasaları, yapay zeka tokenleri. NEXUS size her zincir üstü pazara erişim sağlar.',
    ko: '주식, 원자재, 예측 시장, AI 토큰. NEXUS는 언제 어디서나 모든 온체인 시장에 접근을 제공합니다.',
  },
  ...
  'landing.row2.desc': {
    en: 'NEXUS has privacy baked in at the protocol level. Your strategy is yours. Stealth addresses and shielded transactions keep your positions private.',
    zh: 'NEXUS 在协议层内置隐私。您的策略是您的。隐身地址和屏蔽交易让您的仓位保持私密。',
    es: 'NEXUS tiene privacidad integrada a nivel de protocolo. Tu estrategia es tuya. Direcciones sigilosas y transacciones blindadas.',
    ru: 'В NEXUS конфиденциальность встроена на уровне протокола. Ваша стратегия — только ваша.',
    pt: 'NEXUS tem privacidade incorporada no nível do protocolo. Sua estratégia é sua.',
    ar: 'NEXUS يتضمن الخصوصية على مستوى البروتوكول. استراتيجيتك لك وحدك.',
    tr: 'NEXUS gizliliği protokol seviyesinde yerleşiktir. Stratejiniz sizindir.',
    ko: 'NEXUS는 프로토콜 수준에서 프라이버시를 내장했습니다. 전략은 당신만의 것입니다.',
  },
  ...
  'landing.chain.title': { en: 'NEXUS Chain', zh: 'NEXUS 链', es: 'NEXUS Chain', ru: 'NEXUS Chain', pt: 'NEXUS Chain', ar: 'سلسلة NEXUS', tr: 'NEXUS Zinciri', ko: 'NEXUS 체인' },
  'landing.chain.sub': {
  ...
  'landing.mobile.title': { en: 'NEXUS in Your Pocket', zh: 'NEXUS 随身携带', es: 'NEXUS en tu bolsillo', ru: 'NEXUS в кармане', pt: 'NEXUS no seu bolso', ar: 'NEXUS في جيبك', tr: 'Cebinizde NEXUS', ko: '주머니 속 NEXUS' },
  'landing.mobile.desc': {
    en: 'Never miss an opportunity with the NEXUS mobile app. Trade BTC, ETH, SOL and thousands of altcoins from anywhere. Available on iOS and Android.',
    zh: '随时随地不错过任何机会，使用 NEXUS 移动应用。支持 iOS 和 Android。',
    es: 'Nunca pierdas una oportunidad con la app móvil de NEXUS. Disponible en iOS y Android.',
    ru: 'Не пропускайте возможности с мобильным приложением NEXUS. Доступно на iOS и Android.',
    pt: 'Nunca perca uma oportunidade com o app móvel NEXUS. Disponível no iOS e Android.',
    ar: 'لا تفوت أي فرصة مع تطبيق NEXUS الجوال. متاح على iOS وAndroid.',
    tr: 'NEXUS mobil uygulamasıyla hiçbir fırsatı kaçırmayın. iOS ve Android\'de mevcut.',
    ko: 'NEXUS 모바일 앱으로 어떤 기회도 놓치지 마세요. iOS와 Android에서 사용 가능.',
  },
  ...
  'landing.cta.sub': {
    en: 'Join thousands of traders already on NEXUS. No KYC. No limits. Full control.',
    zh: '加入已在 NEXUS 上的数千名交易者。无需 KYC，无限制，完全掌控。',
    es: 'Únete a miles de traders en NEXUS. Sin KYC. Sin límites. Control total.',
    ru: 'Присоединяйтесь к тысячам трейдеров на NEXUS. Без KYC. Без ограничений. Полный контроль.',
    pt: 'Junte-se a milhares de traders no NEXUS. Sem KYC. Sem limites. Controle total.',
    ar: 'انضم إلى آلاف المتداولين على NEXUS. لا KYC. لا حدود. سيطرة كاملة.',
    tr: 'NEXUS\'taki binlerce traderla birleşin. KYC yok. Sınır yok. Tam kontrol.',
    ko: '이미 NEXUS에 있는 수천 명의 트레이더와 함께하세요. KYC 없음. 제한 없음. 완전한 통제.',
  },
  ...
  'landing.footer.copyright': {
    en: '© 2025 NEXUS Foundation. All rights reserved.',
    zh: '© 2025 NEXUS 基金会。保留所有权利。',
    es: '© 2025 NEXUS Foundation. Todos los derechos reservados.',
    ru: '© 2025 NEXUS Foundation. Все права защищены.',
    pt: '© 2025 NEXUS Foundation. Todos os direitos reservados.',
    ar: '© 2025 مؤسسة NEXUS. جميع الحقوق محفوظة.',
    tr: '© 2025 NEXUS Foundation. Tüm hakları saklıdır.',
    ko: '© 2025 NEXUS Foundation. 모든 권리 보유.',
  },
