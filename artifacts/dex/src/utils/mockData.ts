...
export function normalizeApiPair(p: any): Pair {
  ...
  return {
    ...
    geckoPrice: parseFloat(p.gecko_price) || undefined,
    geckoPriceUSD: parseFloat(p.gecko_price_usd) || undefined,
    geckoPriceChange24h: p.gecko_price_change_24h !== undefined && p.gecko_price_change_24h !== ''
      ? parseFloat(p.gecko_price_change_24h)
      : undefined,
    // Last actual fill price from our matching engine
    lastTradePrice: parseFloat(p.last_trade_price) || undefined,
  };
}
